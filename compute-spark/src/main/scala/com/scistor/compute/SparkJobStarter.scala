...
object SparkJobStarter extends Logging {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val str: String = "{\"transName\":\"postgresql模型\",\"strategy\":{\"runMode\":\"single\",\"timeUnit\":\"HOUR\"},\"stepList\":[{\"stepFrom\":[],\"stepInfo\":{\"id\":\"c4a4d3ad-6d6a-4bf1-9793-dbf16f21bbf4\",\"name\":\"postgresql_in\",\"stepSource\":\"dataSource\",\"dataSourceStepType\":\"dataSourceInput\",\"stepType\":\"postgre\",\"stepId\":\"958e315bad6c4f40bebc7caf770891a0\",\"stepAttributes\":{\"connectUrl\":\"jdbc:postgresql://192.168.31.193:5432/postgres\",\"read\":{\"type\":\"full\",\"jdbcTimestampColumn\":\"\"},\"dataBaseName\":\"postgres\",\"source\":\"source\",\"write\":null,\"properties\":{\"password\":\"123456\",\"user\":\"postgres\"},\"tableName\":\"source\"},\"inputFields\":[],\"outputFields\":[{\"fieldName\":\"name\",\"streamFieldName\":\"name\",\"fieldType\":\"string\",\"isConstant\":false,\"constantValue\":null},{\"fieldName\":\"address\",\"streamFieldName\":\"address\",\"fieldType\":\"string\",\"isConstant\":false,\"constantValue\":null},{\"fieldName\":\"create_time\",\"streamFieldName\":\"create_time\",\"fieldType\":\"timestamp\",\"isConstant\":false,\"constantValue\":null},{\"fieldName\":\"url\",\"streamFieldName\":\"url\",\"fieldType\":\"string\",\"isConstant\":false,\"constantValue\":null}]}},{\"stepFrom\":[\"postgresql_in\"],\"stepInfo\":{\"id\":\"67e16ff8-fa7f-4832-b5a2-092f54c7bb48\",\"name\":\"postgresql_out\",\"stepSource\":\"dataSource\",\"dataSourceStepType\":\"dataSourceOutput\",\"stepType\":\"postgre\",\"stepId\":\"8d69c6c6a6bc4fd5956c013ea0cd2196\",\"stepAttributes\":{\"connectUrl\":\"jdbc:postgresql://192.168.31.193:5432/postgres\",\"read\":null,\"dataBaseName\":\"postgres\",\"source\":\"sink\",\"write\":{\"saveType\":\"insert\",\"saveMode\":\"append\",\"catalogPattern\":\"\"},\"properties\":{\"tableName\":\"sink\",\"password\":\"123456\",\"user\":\"postgres\"},\"tableName\":\"sink\"},\"inputFields\":[{\"fieldName\":\"name\",\"streamFieldName\":\"name\",\"fieldType\":\"string\",\"isConstant\":false,\"constantValue\":null},{\"fieldName\":\"address\",\"streamFieldName\":\"address\",\"fieldType\":\"string\",\"isConstant\":false,\"constantValue\":null},{\"fieldName\":\"create_time\",\"streamFieldName\":\"create_time\",\"fieldType\":\"timestamp\",\"isConstant\":false,\"constantValue\":null},{\"fieldName\":\"url\",\"streamFieldName\":\"url\",\"fieldType\":\"string\",\"isConstant\":false,\"constantValue\":null}],\"outputFields\":[]}}],\"redisConfig\":{\"host\":\"192.168.31.219\",\"port\":6379,\"password\":null,\"database\":4},\"mysqlConfig\":{\"connection_url\":\"jdbc:mysql://192.168.31.163:3306/compute_shanghai?characterEncoding=utf-8&serverTimezone=Asia/Shanghai&useSSL=false\",\"user_name\":\"root\",\"password\":\"1122333\",\"parameters\":null}}"
